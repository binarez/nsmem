...
#ifndef NSMEM_SEQUENTIAL_ALLOCATOR_HPP
#define NSMEM_SEQUENTIAL_ALLOCATOR_HPP
...
namespace mem
{
	...
	{
	public:
				SequentialAllocator( void * pBegin, void * pEnd )
...
#endif // NSMEM_SEQUENTIAL_ALLOCATOR_HPP
